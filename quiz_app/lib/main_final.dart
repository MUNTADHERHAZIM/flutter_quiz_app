...
import 'screens/enhanced_quiz_taking.dart';

void main() {
  runApp(const FinalQuizApp());
}

class FinalQuizApp extends StatelessWidget {
  const FinalQuizApp({super.key});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'نظام الاختبارات الاحترافي - النسخة النهائية',
      theme: ThemeData(
      ...
      if (user != null && user.password == _passwordController.text) {
        if (mounted) {
          ...
          if (_storage.isAdmin(user)) {
            ...
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => EnhancedTeacherDashboard(user: user)),
            );
          } else {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => EnhancedStudentDashboard(user: user)),
            );
          }
        }
      } else {
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                              'مدير النظام: admin@quiz.com | admin123\n'
...
class EnhancedTeacherDashboard extends StatefulWidget {
  ...
  const EnhancedTeacherDashboard({super.key, required this.user});

  @override
  State<EnhancedTeacherDashboard> createState() => _EnhancedTeacherDashboardState();
}
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                              'نظام متطور مع حفظ دائم للبيانات',
                              style: GoogleFonts.cairo(
                                fontSize: 14,
                                color: Colors.grey[600],
                              ),
                          ...
                          ? Center(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  Text(
                                    'ابدأ بإنشاء اختبارك الأول\nالبيانات ستبقى محفوظة بشكل دائم',
                                    style: GoogleFonts.cairo(
                                      fontSize: 14,
...
class EnhancedStudentDashboard extends StatefulWidget {
  ...
  const EnhancedStudentDashboard({super.key, required this.user});
                  ...
                  ? Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text(
                            'ستظهر الاختبارات هنا فور إنشائها من المعلمين\nالبيانات محفوظة بشكل دائم',
                            style: GoogleFonts.cairo(
                              fontSize: 14,
                              color: Colors.grey[500],
                            ),
